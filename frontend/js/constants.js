const contractAddress = "0x33B0e59da91cAe1EFa1A31EEc5384E9832193c49"; //Replace with your own contract address
const chain = 'rinkeby'; // rinkeby or polygon

const welcome_h1 = "Welcome to SUGARCORE X";
const welcome_h2 = "Connect to MetaMask to Get Started";
const welcome_p = 'Our goal is to create a fun and engaging place that brings communities together through IRL and virtual events. We will bridge anime fans, artists, EDM musicians, gamers, vtubers, cosplayers and crypto enthusiasts together.SUGARCORE X Non-Fungible Tokens will be your all access pass to an entire year of gaming/cosplay events, exclusive (wink) perks and DJ/music events. We\'ll post our progress, partnerships and events here. Let\'s build awesome experiences together!.';
...
const p_presale_mint_not_whitelisted = "It seems you're not whitelisted for the presale.";
